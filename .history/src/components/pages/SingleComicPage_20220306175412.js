    ...
    return ( 
        ...
        <div className="single-comic">
            ...
            <div className="single-comic__info">
                <h2 className="single-comic__name">sdcs</h2>
                <p className="single-comic__descr">sdsd</p>
                <p className="single-comic__descr">sdcsdc</p>
                <p className="single-comic__descr">sdcsdc</p>
                <div className="single-comic__price">adcsdcsdc</div>
            </div>
