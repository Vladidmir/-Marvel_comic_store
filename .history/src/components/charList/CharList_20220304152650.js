...
const CharList = ({onCharSelected}) => {
    ...
    useEffect(() => {
        ...
        const infinityObserver = new IntersectionObserver(loadMore)

        if (scrollRef.current) infinityObserver.observe(scrollRef.current)

        return () => infinityObserver.unobserve(scrollRef.current)
        

    }, [scrollRef, newItenLoading])
